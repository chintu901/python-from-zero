...
> [!NOTE]
> You won't need to understand all the details behind this, but Python "private" members aren't truly private. Python just changes their names with "name mangling" to make outside access less straightforward.
